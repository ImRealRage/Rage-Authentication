    ...
    return (
      ...
      >
        ...
        <motion.div
            ...
            <p className='text-gray-300'>
                <span className='font-bold'>Are you verified: </span>
                {user.isVerified ? "Yes" : "No"}
            </p>
            <p className='text-gray-300'>
                <span className='font-bold'>Last updated at: </span>
                {user.updatedAt ? formatDate(user.updatedAt) : "No data was updated"}
            </p>
        </motion.div>
        </div>
        ...
        >
            ...
            className='w-full py-3 px-4 bg-gradient-to-r from-purple-500 to-blue-600 text-white font-bold rounded shadow-lg hover:from-purple-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:ring-offset-gray-900'
            >
            Logout  
            </motion.button>
